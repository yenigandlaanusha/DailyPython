...
| Authentication Mechanism | Basic Auth with CConnect Username - Password |
| Request Headers | 'Content-type': 'application/json',  <br> 'Accept': 'application/json' |
| Request Body | { <br> "hostname": "&lt;host.hostname&gt;", <br> "server_type": "&lt;host.server_type&gt;" <br> } |
| Response Headers | As per table |
| Response Body | { <br>&nbsp; "url" : "certmgmt/host/&lt;host.host_id&gt;", <br>&nbsp; "id": "&lt;host.host_id&gt;", <br>&nbsp; "hostname": "&lt;host.hostname&gt;", <br>&nbsp; "server_type": "&lt;host.server_type&gt;", <br>&nbsp; "onboarding_time": "&lt;host.added_time.isoformat()&gt;", <br>&nbsp; "secret_key": "&lt;host.secret_key&gt;", <br>&nbsp; "old_secret_key": "&lt;host.old_secret_key&gt;", <br>&nbsp; "secret_update_time": "&lt;host.secret_update_time.isoformat()&gt;", <br>&nbsp; "last_contact_time": "&lt;host.last_contact_time.isoformat()&gt;" <br> } |
...
| Response Headers | As per table |
| Response Body | { <br>&nbsp; "url": "certmgmt/host/&lt;host.host_id&gt;/auditlogs", <br>&nbsp; "audit_data" : [ <br>&nbsp; &nbsp; { <br>&nbsp; &nbsp; &nbsp; &nbsp; "id": &lt;audit.audit_id&gt;, <br>&nbsp; &nbsp; &nbsp; &nbsp; "datetime": &lt;audit.datetime.isoformat()&gt;, <br>&nbsp; &nbsp; &nbsp; &nbsp; "host_id": &lt;audit.host_id&gt;, <br>&nbsp; &nbsp; &nbsp; &nbsp; "activity": &lt;audit.activity&gt;, <br>&nbsp; &nbsp; &nbsp; &nbsp; "details": &lt;audit.details&gt; <br>&nbsp; &nbsp; } <br>&nbsp; ] <br> } |
| Success Response Status | 200 |
...
| Request Headers | 'Content-type': 'application/json',  <br> 'Accept': 'application/json' |
| Response Headers | As per table |
| Request Payload | {<br>&nbsp;&nbsp;"url": "certmgmt/email_lists",<br>&nbsp;&nbsp;"email_list_data": <br>&nbsp;&nbsp;[<br>&nbsp;&nbsp;&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"email_list_id": "&lt;email_list_id&gt;",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"email_list_name": "&lt;email_list_name&gt;",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"to": [&lt;{"email1@xyz.com", "email2@xyz.com"}&gt;],<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"cc": [&lt;{"email1@xyz.com", "email2@xyz.com"}&gt;]<br>&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;]<br>} |
| Success Response Status | 200 |
...
| Request Headers | 'Content-type': 'application/json',  <br> 'Accept': 'application/json' |
| Response Headers | As per table |
| Response Body | { <br>&nbsp; "email_list_id": &lt;email_list_id&gt;, <br>&nbsp; "email_list_name": &lt;email_list_name&gt;, <br>&nbsp; "to": &lt;[{"email1@xyz.com", "email2@xyz.com"}]&gt;, <br>&nbsp; "cc": &lt;[{"email1@xyz.com", "email2@xyz.com"}]&gt; <br>} |
| Success Response Status | 200 |
